-- db2 -td@ -f sp_gensubregionmarkupalltile.sql
-- db2 "CALL validation.gensubregionmarkupalltile('oligoIII.2_40x_20x_NS-MORPH_1')"
DROP PROCEDURE validation.gensubregionmarkupalltile @
CREATE PROCEDURE validation.gensubregionmarkupalltile()
LANGUAGE SQL
BEGIN
  ...
  DECLARE c1 CURSOR WITH HOLD FOR
     SELECT distinct tilename FROM VALIDATION.SUBREGION;
