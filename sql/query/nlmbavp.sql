...
update bchmk.querytime set endtime = current timestamp where queryname = 'tiledensity';
...
echo 'tilefeatureselection';
insert into bchmk.querytime SELECT 'tilefeatureselection', current timestamp, null  FROM sysibm.sysdummy1;
